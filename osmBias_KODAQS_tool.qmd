...
**Step 1: Prepare the OSM POI data**\
...
**Step 2: Create comparable POI indicators**\
Construct the same POI-based measures (e.g., counts) using both OSM and official POI datasets. Compare these indicators to identify differences in coverage per administrative geographic unit.\
